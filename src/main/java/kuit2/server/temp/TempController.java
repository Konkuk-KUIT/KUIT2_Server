...
public class TempController {
    ...
    public void requestBodyJsonV2(@RequestBody UserData userData, HttpServletResponse resp) throws IOException {
        log.info("nickname = {}, age = {}", userData.getNickname(), userData.getAge());
    ...
    public UserData responseBodyJsonV1(HttpEntity<UserData> httpEntity) {
        log.info("nickname = {}, age = {}", httpEntity.getBody().getNickname(), httpEntity.getBody().getAge());
    ...
    public UserData responseBodyJsonV2(@RequestBody UserData userData) {
        log.info("nickname = {}, age = {}", userData.getNickname(), userData.getAge());
    ...
    public HttpEntity<UserData> responseBodyJsonV3(@RequestBody UserData userData) {
        log.info("nickname = {}, age = {}", userData.getNickname(), userData.getAge());
    ...
    public ResponseEntity<UserData> responseBodyJsonV4(@RequestBody UserData userData) {
        log.info("nickname = {}, age = {}", userData.getNickname(), userData.getAge());
    ...
    @PostMapping("/response-body-json-v5")
    public UserData responseBodyJsonV5(@RequestBody UserData userData) {
        log.info("nickname = {}, age = {}", userData.getNickname(), userData.getAge());
